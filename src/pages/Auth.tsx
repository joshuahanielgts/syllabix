  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <motion.div
        ...
        className="w-full max-w-sm panel-elevated rounded-lg p-8"
      >
        ...
        <Button
          ...
          className="w-full h-11 font-mono text-sm tracking-wide"
        >
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground font-sans">
          By signing in, you agree to let SyllabiX analyze your uploaded documents.
        </p>
      </motion.div>
    </div>
  );
